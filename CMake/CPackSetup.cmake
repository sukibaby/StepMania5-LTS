...
set(CPACK_PACKAGE_EXECUTABLES "${SM_EXE_NAME}" "StepMania 5 LTS")
...
if(WIN32)
  ...
  set(CPACK_PACKAGE_INSTALL_DIRECTORY "StepMania 5 LTS")
  set(CPACK_PACKAGE_INSTALL_REGISTRY_KEY "StepMania 5 LTS")
  set(CPACK_NSIS_EXECUTABLES_DIRECTORY "Program")
  set(CPACK_NSIS_INSTALL_ROOT "C:\\\\Games")

  set(CPACK_NSIS_HELP_LINK "https://github.com/SM5-LTS/SM5-LTS/issues")
  set(CPACK_NSIS_PACKAGE_NAME "${SM_EXE_NAME} ${CPACK_PACKAGE_VERSION}")
  set(CPACK_NSIS_URL_INFO_ABOUT "https://www.SM5-LTS.com/")
  ...
  set(CPACK_SM_NSIS_PRODUCT_ID "SM5-LTS")
